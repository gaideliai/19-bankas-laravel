...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Pridėti lėšų</div>

                <div class="card-body">
                    <form method="POST" action="{{route('account.addFunds',[$account])}}">
                        ...
                        @csrf
                        <button class="btn btn-primary" type="submit">Pridėti lėšų</button>
                    </form>
                </div>
            </div>
        </div>
